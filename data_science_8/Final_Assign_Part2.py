...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Vehicle_Type',
            y='Automobile_Sales',
            #marker_color=['red', 'blue', 'green', 'crimson'],
            title="Average Automobile Sales fluctions over Vehicle Type"))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            ...
            title="Average Advertising Expentiture fluctions over Vehicle Type"))
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(
            figure=px.line(yas, 
                x='Year',
                y='Automobile_Sales',
                title='Average Automobile Sales fluctuation over year {}'.format(input_year)))
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        sizes = exp_data.values
        Y_chart4 = dcc.Graph(
            figure=px.pie(sizes,
            labels=labels,
            title='Average Advertising Expentiture fluctions over Vehicle Type in the year {}'.format(input_year)))
